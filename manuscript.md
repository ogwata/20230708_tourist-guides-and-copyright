...
- [著作権法](https://elaws.e-gov.go.jp/document?lawid=345AC0000000048)
    - 13条により、<u>憲法その他の法令は「この章の規定による権利の目的となることができない</u>」（→著作権がない）と規定されていて、自由に利用可能
- 以下では、根拠を明確にするために、なるべく実際の条文に沿いつつ著作物の自由な利用方法について説明します
- なお、「→」は「つまり」と読み替えてください
...
- **32条1項：**<u>公表された著作物は、引用して利用することができる。</u>この場合において、その引用は、<u>公正な慣行</u>に合致するものであり、かつ、報道、批評、研究その他の引用の目的上<u>正当な範囲内</u>で行なわれるものでなければならない。
    - →どの利用規程の条文よりも適用範囲が広い（[→表現の自由](https://elaws.e-gov.go.jp/document?lawid=321CONSTITUTION)）
...
- 慣習として最少限度、以下の2つが必須（[万国著作権条約](https://www.cric.or.jp/db/treaty/bap_index.html)に由来）
    - 著作者名
    - 第1発行年
...
- **ネット上で個人が公開している映画、テレビ番組の多くは「私的使用」で録画したビデオと思われる**
    - **30条：**（前略）個人的に又は家庭内その他これに準ずる限られた範囲内において使用すること（以下「私的使用」という。）を目的とするときは、次に掲げる場合を除き、その使用する者が複製することができる。
- **私的使用を目的に録画したビデオを、著作者に無断でネット公開するのは28条違反**

# 映画・テレビを利用できるか？③

- →ネット上で違法に公開された映画・テレビ等のスチールを、著作者に無断で利用するのは二重の違反行為
    - さらに私達のガイドは有償であり、法的には営利活動
- →著作権者の側から見れば、きわめて悪質な行為に映るはず
- もし著作者やその関係者に見とがめられれば重大なトラブルに
- ただし、原著作者が了承しさえすれば問題なし
    - →たとえばNHKのような公益的な団体の著作物は、協会が窓口になって交渉する選択肢もあるのでは？

# 結局、なにがOKで、なにがNG？

- [「横須賀市文化財調査報告書」](https://ci.nii.ac.jp/ncid/BN03568971)はガイド資料として自由に利用可能
- [国立国会図書館デジタルコレクション](https://dl.ndl.go.jp/ja/)等も規約に従って利用可能
- 書籍、雑誌、新聞、あるいはネットに掲載されている写真、マンガ、小説、エッセイ、評論、報道記事、学術研究、史料等は、引用の要件を満たせばガイド資料として利用可能
- ただし、映画・テレビ番組などの動画、あるいはキャラクターグッズ等をガイド資料として使うのは2次的著作物になる可能性が高く、その場合は原著作者の許諾が必要
