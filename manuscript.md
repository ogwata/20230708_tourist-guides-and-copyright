...
- 著作権法からみたガイド資料の可否を考えます
- ガイド資料とは「史跡案内を目的に来場者に示す紙の資料」です
...
- [国立国会図書館デジタルコレクション](https://dl.ndl.go.jp/ja/)も70年以上前なら利用可能
- 書籍、雑誌、新聞、あるいはネットに掲載されている写真、マンガ、小説、エッセイ、評論、報道記事、学術論文等は、引用の要件を満たせばガイド資料として自由に利用可能
